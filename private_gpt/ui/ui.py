...
from private_gpt.ui.ui_utils import chat_all
    ...
    def _build_ui_blocks(self) -> gr.Blocks:
        ...
        with gr.Blocks(
            ...
            with gr.Row(equal_height=False):
                ...
                with gr.Column(scale=12, elem_id="col"):
                    # Determine the model label based on the value of PGPT_PROFILES
                    # TODO: Modify this part so that it supports a list
                    model_label = get_model_label()
                    method_labels = ["RAG", "PCA", "DeepSearch"]
                    ...
                    for idx, method in enumerate(method_labels):
                        with gr.Row():
                            ...
                            with gr.Column(scale=1):
                                gr.HTML('<div class="custom-box">Visualization Here</div>')
